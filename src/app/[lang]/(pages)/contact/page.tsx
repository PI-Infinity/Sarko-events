...
const Contact = () => {
  ...
  return (
    <div
      ...
      className="font-secondFont oveflow-hidden w-[100%] slide-in-top  flex-col desktop:flex-row items-center desktop:items-start px-6 desktop:px-[5%] gap-4 desktop:pb-[24px]"
    >
