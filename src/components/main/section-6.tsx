...
export const Section6 = ({ sY }: any) => {
  ...
  return (
    <div
      ...
      style={{ position: "absolute", top: isMobile ? "4600px" : "6700px" }}
    >
      <div className="w-full flex items-center justify-between relative">
        ...
        <motion.div className="absolute right-[-10px] desktop:right-[-20px] top-[70px] desktop:top-[400px] w-[100px] h-[65px] rounded-[6px] desktop:rounded-3xl desktop:w-[270px] desktop:h-[200px] rounded-[10px] desktop:rounded-[40px] overflow-hidden">
          <img
            src="/freesbe.webp"
            alt="Sarko"
            style={{ width: "100%", height: "100%" }}
      ...
      <div className="relative bottom-[50px] desktop:bottom-0 w-[90%] desktop:w-[1100px] text-[48px] desktop:text-[124px] text-center font-mineFont  text-white">
        <motion.p
          style={{
            position: "relative",
            bottom: transfer,
